...
const routes: Routes = [
  {path:"login",component:LoginComponent},
  {
    path:"admin",component:AdminTemplateComponent,canActivate:[AuthenticationGuard], children:[
      ...
      {path:"newenseignant",component:NewEnseignantComponent,canActivate:[AuthorizationGuard],
        data : { requiredRoles : 'ADMIN'}
      },
      {path:"editenseignant/:id",component:EditEnseignantComponent,canActivate:[AuthorizationGuard],
        data : { requiredRoles : 'ADMIN'}
      },
